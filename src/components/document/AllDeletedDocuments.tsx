                    ...
                    <div className=" w-full bg-white flex flex-col items-center p-6 text-center rounded-md justify-center space-y-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-gray-500 max-w-md">
                                These are all deleted documents. You've the possibility to restore them. These files will be deleted authomatically after 30 days if not restored. Only admin can see this.
                            </p>
                        </div>
                    </div>
                ) : (
